...
public class Registration_of_firm_01 extends BaseClass{
	...
	public void firm_process() throws Throwable {
		...
		start_Report(excel.readExcelData("MEE_REG_OF_FIRM", 6, 0), excel.readExcelData("MEE_REG_OF_FIRM", 6, 1), excel.readExcelData("MEE_REG_OF_FIRM", 6, 2));
		...
		wUtility.select(firm.getApplicantMandalDropDown(), 0);
		...
		wUtility.enterDataUsingJavaScript(driver, firm.getFirmDurationFromDateSelect(), excel.readExcelData("Firm_User_Data", 9, 1));
...
//		
		...
		wUtility.enterDataUsingJavaScript(driver, firm.getPartnerJoiningDateTextField(), excel.readExcelData("Firm_User_Data", 20, 1));
		...
		wUtility.enterDataUsingJavaScript(driver, firm.getPartnerJoiningDateTextField(), excel.readExcelData("Firm_User_Data", 20, 2));
